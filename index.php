	...
	<body style="overflow:hidden">
			<div class="intro-header" style="height:100%">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div id="index" class="intro-message" style="padding-top:10%;">
							...
							<ul class="list-inline">
								...
								<li>
									<a href="dailylog.php" class="btn btn-default btn-lg"><span class="network-name"><i class="fa fa-list-alt faa-horizontal animated"></i>&nbsp;&nbsp DAILY LOG </span></a>
								</li>
								<li>
									<a href="reminders.php" class="btn btn-default btn-lg"><span class="network-name"><i class="fa fa-tasks faa-flash animated"></i>&nbsp;&nbsp REMINDERS </span></a>
								</li>
								<li>
